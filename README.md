...
В `3-ей` лабораторной работе я выполнила следующие задания:
- добавление конструкторов(по умолчанию, с параметрами)
- добавление операторов(копирования, сравнения, ввода/вывода)
- добавление абстрактного класса 

В `4-ой` лабораторной работе были выполнены следующие требования:
